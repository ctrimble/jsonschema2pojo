...
public class MediaIT {
    ...
    public static void generateAndCompileClass() throws ClassNotFoundException {
        ...
        ClassLoader resultsClassLoader = staticSchemaRule.generateAndCompile("/schema/media/mediaProperties.json", "com.example", config("customAnnotator", QuotedPrintableAnnotator.class.getName()));
