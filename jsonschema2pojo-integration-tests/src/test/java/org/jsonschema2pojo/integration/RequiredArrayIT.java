...
public class RequiredArrayIT extends RequiredIT {
    ...
    public static void generateClasses() throws ClassNotFoundException, IOException {
        ...
        staticSchemaRule.generateAndCompile("/schema/required/requiredArray.json", "com.example");
        File generatedJavaFile = staticSchemaRule.source("com/example/RequiredArray.java");
