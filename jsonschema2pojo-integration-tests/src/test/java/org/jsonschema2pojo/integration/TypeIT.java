...
public class TypeIT {
    ...
    public static void generateAndCompileClass() throws ClassNotFoundException {
        ...
        classWithManyTypes = staticSchemaRule.generateAndCompile("/schema/type/types.json", "com.example")
    ...
    public void reusingTypeFromClasspathProducesNoNewType() throws NoSuchMethodException {
        ...
        assertThat(staticSchemaRule.source("java/util/Locale.java").exists(), is(false));
